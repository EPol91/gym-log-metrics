...
const ICONS: Record<Tab, ReactNode> = {
  ...
  habits: ico(<>
    <rect x="1.6" y="3.4" width="14.4" height="13.2" rx="2.2" />
    <path d="M5.2 1.8v3.2M12.4 1.8v3.2M1.6 7.2h14.4" />
    <path d="M8.8 7.2v9.4M1.6 11.9h14.4" />
    <path d="M3.6 9.3l.9.9 1.7-2M10.8 9.3l.9.9 1.7-2M3.6 14l.9.9 1.7-2" />
    <path d="M16.2 17.3c.9-1.4 1.7-2.1 2.5-2.1 1.1 0 1.9 1 1.9 2.1s-.8 2.1-1.9 2.1c-.8 0-1.6-.7-2.5-2.1zm0 0c-.9-1.4-1.7-2.1-2.5-2.1-1.1 0-1.9 1-1.9 2.1s.8 2.1 1.9 2.1c.8 0 1.6-.7 2.5-2.1z" />
  </>),
